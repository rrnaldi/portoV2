...
<div class="container mx-auto p-6 bg-white shadow-md rounded-lg">
    <h1 class="text-2xl font-bold mb-4 text-gray-800">Create Certificate</h1>
    ...
    <form action="{{ route('certificates.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="file" name="imagesertif" accept="image/*" class="border border-gray-300 rounded-md p-2 w-full">
        </div>
